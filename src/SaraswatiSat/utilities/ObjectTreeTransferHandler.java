...
public class ObjectTreeTransferHandler extends StringTransferHandler implements java.io.Serializable 
{
    ...
    // constructor
    public ObjectTreeTransferHandler(Hashtable<String,AbstractSatellite> satHash, Hashtable<String,GroundStation> gsHash, SaraswatiSAT app, IconTreeNode topSatTreeNode, IconTreeNode topGSTreeNode)
    {
