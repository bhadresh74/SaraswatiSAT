 ...
 * @author Bhadresh
 */
public class navigatepanel extends JLabel implements java.io.Serializable
{
    ...
    Vector<SaraswatiSATRenderable> renderableObjects = new Vector<SaraswatiSATRenderable>();
    ...
    // need a copy of the parent navigate -- just for Earth lights function
    private transient navigate earthPanel;
    
    // hidden option -- mostly for debug -- Toggle this using "f" key when a 2D window is active
    public boolean showFPS = false;
    private final DecimalFormat df = new DecimalFormat("#,##0.000");
    
    public navigatepanel(ImageIcon image, double aspect, Hashtable<String,AbstractSatellite> satHash, Hashtable<String,GroundStation> gsHash, Color backgroundColor, Time currentTime, Sun sun, navigate earthPanel1)
    {
        //super(image);
...
//        }
    ...
    private void finishPainting(Graphics g)
    {
        ...
        for(SaraswatiSATRenderable renderable : renderableObjects)
        {
        ...
        g2.setStroke(new BasicStroke(1, BasicStroke.CAP_BUTT,
                ...
                dashPattern, 0));
        //JOptionPane.showInputDialog(imageWidth+"and"+imageHeight);
        if(showLatLong)
        {
            for(int lat = -90; lat <= 90; lat+=30)
            {
                ...
                //JOptionPane.showInputDialog(" "+w+" "+h+" "+imageWidth+" "+imageHeight);
...
//================================================================================================
    ...
    //  the above assumption is for navigate!! because it on't draws on the image exactly
...
//            g2.setPaint( transColor );
    ...
    public boolean removeRenderableObject(SaraswatiSATRenderable renderable)
    {
    ...
    public Vector<SaraswatiSATRenderable> getRenderableObjects()
    {
