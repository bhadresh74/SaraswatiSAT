...
import SaraswatiSat.utilities.IconTreeNode;
import SaraswatiSat.utilities.IconTreeNodeRenderer;
import SaraswatiSat.utilities.ObjectTreeTransferHandler;
...
public class JObjectListPanel extends javax.swing.JPanel
{
    ...
    public JObjectListPanel( Hashtable<String,AbstractSatellite> satHashIn, Hashtable<String,GroundStation> gsHash, SaraswatiSAT app )
    {
    ...
    public void openCurrentOptions(Object obj)
    {
        ...
        if(satHash.containsKey(nameSelected))
        {
            ...
            JOptionPane.showInputDialog(windowName);
            // create new internal frame window
            JInternalFrame iframe = new JInternalFrame(windowName,true,true,true,true);
