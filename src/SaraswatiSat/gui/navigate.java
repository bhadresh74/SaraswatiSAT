...
import SaraswatiSat.covergae.SaraswatiSATRenderable;
import SaraswatiSat.objects.AbstractSatellite;
import SaraswatiSat.objects.GroundStation;
import SaraswatiSat.utilities.LandMassRegions;
...
public class navigate extends JDesktopPane implements ComponentListener , java.io.Serializable
{
    // options
    ...
    private navigatepanel imageMap;
    ...
    //Hashtable<String,SatelliteProps> satHash = new Hashtable();
     ...
     // app
     private transient SaraswatiSAT app;
...
//    Color landOutlineColor = Color.WHITE;
    ...
    public navigate(Hashtable<String,AbstractSatellite> satHash, Hashtable<String,GroundStation> gsHash, Time currentTime, Sun sun, SaraswatiSAT app)
    {
...
//        }
    ...
    private void iniObject(Hashtable<String,AbstractSatellite> satHash, Hashtable<String,GroundStation> gsHash)
    {
        ...
        imageMap = new navigatepanel(planetImage,aspectRatio, satHash, gsHash, backgroundColor, currentTime, sun, this);
...
//        popup.addSeparator();
  ...
  */
    ...
    {
        java.net.URL imgURL = navigate.class.getResource(path);
        if (imgURL != null)
        {
        ...
        else
        {
            ...
            imgURL = navigate.class.getResource(backgroundImagePath);
...
//		int b2 = (dimg.getRGB(j, i) ) & 0xff;
   ...
   public void updateEarthLightMaskAndRecombineImage()
   {
     ...
     * @return image scaled appropriataly
     */
...
//  An inner class to check whether mouse events are the popup trigger
    class MousePopupListener extends MouseAdapter
    {
        ...
        private void checkPopup(MouseEvent e)
        {
            if (e.isPopupTrigger())
            {
                popup.show(navigate.this, e.getX(), e.getY());
            }
        }
...
//    }
     ...
     * @param renderable
     */
    public void addRenderableObject(SaraswatiSATRenderable renderable)
    {
    ...
    public boolean checkIfIncludesRenderableObject(SaraswatiSATRenderable renderable)
    {
        // check to see if object is in list
        for(SaraswatiSATRenderable ren : imageMap.getRenderableObjects())
        {
    ...
    public void removeRenderableObject(SaraswatiSATRenderable renderable)
    {
        Vector<SaraswatiSATRenderable> renVec = imageMap.getRenderableObjects();
    ...
    public navigatepanel getImageMap()
    {
        return imageMap;
    }
    ...
    /**
     * Performs an offscreen rendering of panel, works best when used with "getNonDisplayed2DEarthPanel()" function in SaraswatiSAT class
     * @return
     */
